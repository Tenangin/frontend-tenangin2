    ...
    <>
      <main id="main-content" className="container my-3">
        ...
        >
          ...
          <p className="lead">
            Empowering students to take charge of their mental health.
          </p>
        </div>
        ...
        <section className="my-5">
          ...
          <p className="lead text-center mx-auto" style={{ maxWidth: "700px" }}>
            ...
            concern, with over 30% experiencing mental health disorders.
            Tenangin aims to provide accessible digital solutions to support
            students in managing their mental well-being effectively.
          </p>
        </section>
              ...
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    A tool to help students recognize their mental health status
                    through a series of questions and assessments, providing
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    A recommendation system that connects students with nearby
                    counselors based on their location, making it easier to
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    A journaling feature that allows students to track their
                    emotional progress over time, helping them reflect on their
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    An AI-powered chatbot that provides instant support and
                    guidance, answering common questions and offering resources
                    for mental health.
                  </p>
                </div>
              </div>
        ...
        <section className="my-5 text-center p-5 bg-light rounded">
          ...
          <p className="lead mb-4">
            Together, we can create a supportive environment for students to
