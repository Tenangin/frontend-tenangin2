...
const SentimentProgressBar = ({ sentimentResults, small = false }) => {
  ...
  // Definisikan hanya style yang statis/dasar di sini
  const baseItemStyle = {
    flex: "1 1 200px",
    minWidth: "180px",
    maxWidth: "250px",
  ...
  const percentageStyle = { fontSize: small ? "12px" : "16px" };
      ...
      {sentiments.map(([sentiment, score]) => {
        ...
        return (
          <div
            ...
            style={dynamicItemStyle} // Gunakan objek style yang baru
          >
            <div
              className="me-3"
              style={{ padding: small ? "0 4px 0 0" : undefined }}
            >
              <span style={emojiStyle}>{sentimentData.emoji}</span>
            </div>
            <div className="flex-grow-1">
              ...
              >
                <div
                  ...
                  style={{
                    width: `${percentage}%`,
                    // Logika warna progress bar bisa disederhanakan jika Anda mau
